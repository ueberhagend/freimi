		...
		<div class="fields">
			...
			<div class="half" style="width:700px;!important">
				<div style="width:700px;">
					<div style="float:left;width:100px;margin-right: 20px;"><p class="btn cancel">Type</p></div>
				...
				<?php
					...
					$query = "https://noob.aiesec.de/outgoerPreparations?access_token=$token&page=$page&limit=5000&orderby.desc=startDate";
					$answer = file_get_contents($query);
					$json = json_decode($answer);
					$json = $json->payload;
					...
					foreach($json as $key => $ops){
						...
						$endDate = $endDate[0];
				?>
				<a href="index.php?site=createops<?php echo "&id=$id&startDate=$startDate&endDate=$endDate&type=$type&lc=$lc;"?>" class="status" style="font-size:10pt;">
					<div style="float:left;width:100px;margin-right: 20px;"><?php echo $type; ?></div>
